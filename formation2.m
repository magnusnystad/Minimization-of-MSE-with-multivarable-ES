...
b1 = 1.2;                           % backwhirl intercept
c1 = 1.3;                           % penalty coefficient
bwhirl = @(RPM_n)(b1 +a1*RPM_n);

a2 = 0.5;                           % forward whirl slope
b2 = -0.1;                          % forward whirl intercept
c2 = 1.3;                             % penalty coefficient
fwhirl = @(RPM_n)(b2 + a2*RPM_n);

a3 = 0.9;                           % stick slip slope
b3 = 0.1;                          % stick slip intercept
c3 = 0.8;                             % penalty coefficient in sstep approach
